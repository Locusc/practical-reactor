...
public class c5_CreatingSequence {
    ...
    public void optional_value() {
        ...
        Mono<String> optionalMono = Mono.fromSupplier(optionalValue::get);
    ...
    public void repeat() {
        ...
        Flux<Integer> repeated = Mono.fromSupplier(counter::incrementAndGet)
                .flux()
                .repeat(9);
